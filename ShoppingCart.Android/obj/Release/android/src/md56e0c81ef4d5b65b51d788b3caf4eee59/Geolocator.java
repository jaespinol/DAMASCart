package md56e0c81ef4d5b65b51d788b3caf4eee59;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DevAzt.FormsX.Droid.Device.Sensors.Geolocator, ShoppingCart.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", Geolocator.class, __md_methods);
	}
	...
	public Geolocator ()
	{
		...
		if (getClass () == Geolocator.class)
			mono.android.TypeManager.Activate ("DevAzt.FormsX.Droid.Device.Sensors.Geolocator, ShoppingCart.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public Geolocator (android.content.Context p0)
	{
		super ();
		if (getClass () == Geolocator.class)
			mono.android.TypeManager.Activate ("DevAzt.FormsX.Droid.Device.Sensors.Geolocator, ShoppingCart.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
